 ...
 * */
        ...
        /* Methods - Metotlar
         * Sınıf içerisinde tanımlamam fonksiyonlara metot denir.
         * */

        // Events - Olaylar

        /* Operator Overloading - Operatör Tanımlama
         * Sınıf içerisinde tanımlanan operatörlerin davranışları değiştirmek için kullanılır.
         * */

        /* Static - Statik
         * Static fieldlar bellekte sadece bir kere yer kaplarlar.
         * */
        public Giris()
        {
