...
namespace StatikNesneler
{
    ...
    public class Kare : Sekil
    {
        ...
        public static double AlanHesapla(double x) => x * x; //Bir nesnenin içerisine statik nesne tanımlayabilmek için sınıfın statik tanımlanmasına gerek yoktur. Statik tanımlanan sınıflarda tüm sınıf elemanlar statik tanımlanmalıdır.
